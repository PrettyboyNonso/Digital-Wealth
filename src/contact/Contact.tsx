    ...
    <div className="relative">
      ...
      <div className=" min-h-96 border-t flex flex-col lg:flex-row border-solid px-8 md:px-12 py-4 justify-between">
          ...
          <div className="w-full flex flex-col md:flex-row  justify-between mt-6 items-stretch lg:items-stretch md:items-stretch">
            <div className="flex-shrink-0 flex-grow-0 md:basis-[28%] basis-[100%]  md:border-t md:border-b md:border-solid py-4">
              ...
              <p className="capitalize font-mons text-[11px] font-medium mt-3 ">
                ...
                help you with any inquiries, concerns, or issues. We are
                committed to ensuring a seamless trading experience and are
                available to provide expert assistance whenever you need it.
              </p>
            </div>
            ...
            <div className="flex-shrink-0 flex-grow-0 md:basis-[28%] basis-[100%]  md:border-t md:border-b md:border-solid py-4">
              ...
              <p className="capitalize font-mons text-[11px] font-medium mt-3 ">
                We value your input! Your feedback and suggestions are crucial
                to us as we continuously strive to improve our services. Feel
                free to share your thoughts on how we can serve you better. Your
                voice drives our growth and innovation.
              </p>
            </div>
            ...
            <div className="flex-shrink-0 flex-grow-0 md:basis-[28%] basis-[100%]  md:border-t md:border-b md:border-solid py-4">
              ...
              <p className="capitalize font-mons text-[11px] font-medium mt-3 ">
                ...
                our communications team is ready to engage. We welcome
                collaboration and are happy to discuss our services, market
        ...
        <div className="flex-shrink-0 flex-grow-0 basis-[35%] lg:border-solid lg:border-2 rounded-lg px-4 py-6">
          <h1 className="capitalize text-xl font-bold font-mons">
            get in touch
          </h1>
